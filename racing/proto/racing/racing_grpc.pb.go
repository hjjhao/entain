...
type RacingClient interface {
	...
	// Fetch a single race
	GetRace(ctx context.Context, in *GetRaceRequest, opts ...grpc.CallOption) (*ListRacesResponse, error)
}
...
func (c *racingClient) GetRace(ctx context.Context, in *GetRaceRequest, opts ...grpc.CallOption) (*ListRacesResponse, error) {
	out := new(ListRacesResponse)
...
type RacingServer interface {
	...
	// Fetch a single race
	GetRace(context.Context, *GetRaceRequest) (*ListRacesResponse, error)
}
...
func (UnimplementedRacingServer) GetRace(context.Context, *GetRaceRequest) (*ListRacesResponse, error) {
