...
type ListRacesRequestFilter struct {
	...
	Options    *ListRacesRequestOptionFilter `protobuf:"bytes,2,opt,name=options,proto3" json:"options,omitempty"`
}
...
func (x *ListRacesRequestFilter) GetOptions() *ListRacesRequestOptionFilter {
	if x != nil {
		return x.Options
	}
	return nil
...
// Filter for listing races.
type ListRacesRequestOptionFilter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListRacesRequestOptionFilter) Reset() {
	*x = ListRacesRequestOptionFilter{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRacesRequestOptionFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRacesRequestOptionFilter) ProtoMessage() {}

func (x *ListRacesRequestOptionFilter) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRacesRequestOptionFilter.ProtoReflect.Descriptor instead.
func (*ListRacesRequestOptionFilter) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{4}
}

func (x *ListRacesRequestOptionFilter) GetVisibleOnly() bool {
	if x != nil {
...
func (x *ListRacesRequestOptionFilter) GetOrderBy() string {
	if x != nil {
		return x.OrderBy
	}
	return ""
...
func (x *ListRacesRequestOptionFilter) GetOrderDirection() string {
	if x != nil {
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x65, 0x73, 0x22, 0x79, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63,
	...
	,
	...
	0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x44,
	0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe3, 0x01, 0x0a, 0x04, 0x52, 0x61, 0x63,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x8c,
	...
	0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3e, 0x0a,
...
var file_racing_racing_proto_goTypes = []interface{}{
	...
	(*ListRacesRequestOptionFilter)(nil), // 4: racing.ListRacesRequestOptionFilter
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	4, // 2: racing.ListRacesRequestFilter.options:type_name -> racing.ListRacesRequestOptionFilter
	...
	2, // 7: racing.Racing.GetRace:output_type -> racing.ListRacesResponse
...
func file_racing_racing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_racing_racing_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRacesRequestOptionFilter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
